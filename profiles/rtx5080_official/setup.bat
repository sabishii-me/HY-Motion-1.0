@echo off
REM RTX 5080 Official Profile Setup
REM No quantization, uses CPU/RAM offloading for parts that don't fit

cd /d "%~dp0"

set PROFILE_NAME=rtx5080_official
...
echo ========================================
echo RTX 5080 Official Profile Setup
...
echo Config: No quantization (full precision)
echo VRAM: Will use 16GB + system RAM offloading
echo.
echo NOTE: This matches official setup.
echo Slower than quantized versions due to CPU offloading.
echo Use this to compare quality vs INT4/INT8.
echo.
