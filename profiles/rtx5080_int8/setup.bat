@echo off
REM RTX 5080 INT8 Profile Setup
REM Optimized for 16GB VRAM with higher quality

cd /d "%~dp0"

set PROFILE_NAME=rtx5080_int8
...
echo ========================================
echo RTX 5080 INT8 Profile Setup
...
echo Config: INT8 quantization, CUDA 13.0
echo VRAM: ~12-13GB (higher quality than INT4)
echo.
echo WARNING: INT8 uses more VRAM than INT4.
echo Monitor GPU memory during use.
echo.
